...
public class AccountCreditEntryDto {
	...
	public AccountCreditEntryDto(){}

	public AccountCreditEntryDto(String referenceNo, Date referenceDt, String cinNo, long majorheadId, String majorhead, long submajorheadId, String submajorhead, long minorheadId, String minorhead, String subhead, long subheadId, long detailheadId, String detailhead, String entryDesc, Double creditAmount) {
