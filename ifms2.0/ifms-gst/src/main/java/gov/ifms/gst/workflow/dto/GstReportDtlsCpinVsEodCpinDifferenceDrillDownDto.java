...
/**
 * The Class GstReportDtlsCpinVsEodCpinDifferenceDrillDownDto.
 *
 * @version 1.0
 * @created 2022/01/09 17:21:07
 *
 */
public class GstReportDtlsCpinVsEodCpinDifferenceDrillDownDto {

	/** The serialVersionUID. */
	private static final long serialVersionUID = 1L;

	public GstReportDtlsCpinVsEodCpinDifferenceDrillDownDto() {
		super();
	}
	...
	public GstReportDtlsCpinVsEodCpinDifferenceDrillDownDto(Date date, Integer cinNoOfTransaction, Double cinAmount,
