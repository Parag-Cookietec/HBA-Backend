...
/**
 * The Class GstWfActionConfigDto.
 */
@JsonInclude(JsonInclude.Include.NON_NULL)
public class GstWfActionConfigDto implements Serializable {
    ...
    private List<GstWfActionConfigCondition> wfActionConfigDtoList = Collections.emptyList();
     ...
     */
    public List<GstWfActionConfigCondition> getWfActionConfigDtoList() {
     ...
     */
    public void setWfActionConfigDtoList(List<GstWfActionConfigCondition> wfActionConfigDtoList) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GstWfActionConfigDto)) return false;
        GstWfActionConfigDto that = (GstWfActionConfigDto) o;
    ...
    public String toString() {
        final StringBuilder sb = new StringBuilder("GstWfActionConfigDto{");
