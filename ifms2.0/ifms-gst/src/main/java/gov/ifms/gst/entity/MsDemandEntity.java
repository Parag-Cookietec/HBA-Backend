...
public class MsDemandEntity extends BaseEntity implements Serializable {
    ...
    private MsBPNEntity MsBPNEntity;
    ...
    /**
     * Instantiates a new  ms demand entity.
     */
    public MsDemandEntity() {
        super();
    }
     ...
     */
    public MsBPNEntity getBudgetMsBPNEntity() {
        return MsBPNEntity;
    }
     ...
     *
     * @param MsBPNEntity the new budget ms BPN entity
     */
    public void setBudgetMsBPNEntity(MsBPNEntity MsBPNEntity) {
        this.MsBPNEntity = MsBPNEntity;
    }
     ...
     */
    public MsDemandEntity(long demandId) {
        this.demandId = demandId;
    }
}