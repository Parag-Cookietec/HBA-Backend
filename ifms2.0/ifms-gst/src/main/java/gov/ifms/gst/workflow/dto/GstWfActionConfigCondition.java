...
/**
 * The Class GstWfActionConfigCondition.
 */
public class GstWfActionConfigCondition implements Serializable {
    ...
    /**
     * Instantiates a new GST wf action config condition.
     */
    public GstWfActionConfigCondition() {
    }
     ...
     */
    public GstWfActionConfigCondition(String condition) {
