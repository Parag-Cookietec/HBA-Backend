...
@Entity
@Table(name = "TPAO_ACC_DEBIT_ENTRY", schema = GSTConstant.GST_SCHEMA)
public class AccDebitEntry extends BaseEntity implements Serializable {
	public static final String TRN_SCREEN_ABE = "ABE";
	@Id
	@GeneratedValue(strategy = GenerationType.IDENTITY)
	@Column(name = "ACC_DEBIT_ID")
	private long id;
	...
	public AccDebitEntry(long id) {
		super();
		this.id = id;
	}

	public AccDebitEntry() {
		super();
	}
	...
	public static String getTrnScreenAbe() {
		return TRN_SCREEN_ABE;
	}
}
