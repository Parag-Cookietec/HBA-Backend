...
/**
 * The Class GstWfRlBrTypeMenuAuthEntity.
 */


//TODO NEED TO CREATE - TPAO_WF_RL_BR_TYPE_MENU_AUTH table in EPAO SCHEMA

@Entity
@Table(name = "TPAO_WF_RL_BR_TYPE_MENU_AUTH", schema = GSTConstant.GST_SCHEMA)
public class GstWfRlBrTypeMenuAuthEntity extends BaseEntity implements Serializable {
	...
	public boolean equals(Object o) {
		...
		GstWfRlBrTypeMenuAuthEntity that = (GstWfRlBrTypeMenuAuthEntity) o;
	...
	public String toString() {
		final StringBuilder sb = new StringBuilder("GstWfRlBrTypeMenuAuthEntity{");
