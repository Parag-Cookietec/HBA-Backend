...
/**
 * The Interface GstWfActionConfigRepository.
 */
@Repository
public interface GstWfActionConfigRepository extends JpaRepository<GstWfActionConfigEntity,Long> ,
                  JpaSpecificationExecutor<GstWfActionConfigEntity> , GenericDao {
    ...
    List<GstWfActionConfigEntity> findWorkflowRuleIdAndWfActions(@Param("officeTypeId") long officeTypeId, @Param("wfRoleId") long wfRoleId, @Param("menuId") long menuId, @Param("validWfActionId") int validWfActionId, @Param("actionLevel") int actionLevel ,@Param("condition") String condition);
     ...
     * @return
     */
    @Query(value = "SELECT wf.initWfRoleId FROM GstWfActionConfigEntity wf WHERE wf.edpMsMenuEntity.menuId = :menuId AND wf.activeStatus = :activeStatus and  wf.fromOfficeTypeId =:officeTypeId AND (wf.fromIsFD = :isFd or wf.fromIsFD = :defaultIsFd) AND wf.initWfRoleId IS NOT NULL")
     ...
     * @return
     */
    GstWfActionConfigEntity findByActionConfigIdAndActiveStatus(long wfActConfId,int activeStatus);
    ...
    @Query(value = "SELECT new gov.ifms.gst.workflow.dto.WfUserDto(tumwr.lkUserMenuId.poOffUserId.userId.userId,FUNCTION('wf_user_name',tumwr.lkUserMenuId.poOffUserId.lkPoOffUserId) ,tumwr.lkUserMenuId.poOffUserId.lkPostOfficeId.postEntity.postId, tumwr.lkUserMenuId.poOffUserId.lkPostOfficeId.officeEntity.officeId,tumwr.lkUserMenuId.poOffUserId.lkPoOffUserId,tumwr.workflowRoleId ,(select post.postName from EDPMsPostEntity post where post.postId = tumwr.lkUserMenuId.poOffUserId.lkPostOfficeId.postEntity.postId) ) FROM EDPTrnUsrMnuWfRole tumwr WHERE tumwr.workflowRoleId = :nextWfRoleId AND tumwr.lkUserMenuId.menuID = :menuId AND tumwr.lkUserMenuId.poOffUserId.lkPostOfficeId.officeEntity.officeId = :officeId AND tumwr.activeStatus = :activeStatus AND tumwr.lkUserMenuId.activeStatus = :activeStatus AND tumwr.lkUserMenuId.poOffUserId.lkPostOfficeId.officeEntity.activeStatus = :activeStatus AND tumwr.lkUserMenuId.poOffUserId.activeStatus = :activeStatus")
