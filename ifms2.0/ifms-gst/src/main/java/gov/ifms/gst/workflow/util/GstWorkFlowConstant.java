...
/**
 * The Class GstWorkFlowConstant.
 */
public class GstWorkFlowConstant {

    /**
     * Instantiates a new GST work flow constant.
     */
    private GstWorkFlowConstant() {
		super();
	}
	...
	/** The Constant SP_TPAO_WF_TRN_SUBMIT. */
	public static final String SP_GST_WF_TRN_SUBMIT = "TPAO_WF_TRN_SUBMIT";

	/** The Constant SP_PAO_WF_TRN_MV_LY_SUBMIT. */
	public static final String SP_GST_WF_TRN_MV_LY_SUBMIT = "TPAO_WF_TRN_MOVE_SUBMIT";	
	...
	public static final String WF_TRN_BULK_SUBMIT_V3 = "TPAO_WF_TRN_SUBMIT_V3";	
