...
/**
 * The Class GstReportDtlsCpinDto.
 *
 * @version 1.0
 * @created 2022/01/09 17:21:07
 *
 */
public class GstReportDtlsCpinDto {
	...
	/**
	 * Instantiates a new gst report dtls cpin dto.
	 */
	public GstReportDtlsCpinDto() {
		super();
	}
	...
	public GstReportDtlsCpinDto(final String gstIn, final String cin, final String bank, final Date cpinDate, final Double sgstTax,
