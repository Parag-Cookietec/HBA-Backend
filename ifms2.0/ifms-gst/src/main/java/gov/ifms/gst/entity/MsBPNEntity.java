...
public class MsBPNEntity extends BaseEntity implements Serializable {
	...
	/**
	 * Instantiates a new  ms BPN entity.
	 */
	public MsBPNEntity() {
		super();
	}
	 ...
	 */
	public MsBPNEntity(long bpnId, String bpnCode) {
		super();
		this.bpnId = bpnId;
		this.bpnCode = bpnCode;
	}
	 ...
	 * @param bpnCode the bpn code
	 */
	public MsBPNEntity(String bpnCode) {
		super();
		this.bpnCode = bpnCode;
	}
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof MsBPNEntity)) {
			return false;
		}
		MsBPNEntity other = (MsBPNEntity) obj;
