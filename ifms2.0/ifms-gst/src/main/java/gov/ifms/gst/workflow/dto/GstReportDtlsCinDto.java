...
/**
 * The Class GstReportDtlsCinDto.
 *
 * @version 1.0
 * @created 2022/01/09 17:21:07
 *
 */
public class GstReportDtlsCinDto {
	...
	public GstReportDtlsCinDto(final String gstIn, final String cin, final Date paymentDate, final String bankCd, final Double sgstTax,
