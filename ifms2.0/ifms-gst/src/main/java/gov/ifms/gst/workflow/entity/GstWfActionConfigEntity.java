package gov.ifms.gst.workflow.entity;
...
/**
 * The Class GstWfActionConfigEntity.
 */
@Entity
@Table(name = GstDBConstants.PAO_WF_ACTION_CONFIG, schema = GstDBConstants.GST_SCHEMA)
public class GstWfActionConfigEntity implements Serializable {
    ...
    @Column(name = GstDBConstants.ACTIONCONFIG_ID)
    private long actionConfigId;

    /** The edp ms menu entity. */
    @ManyToOne(fetch = FetchType.LAZY, optional = false)
    @JoinColumn(name = GstDBConstants.MENU_ID, referencedColumnName = GstDBConstants.MENU_ID)
    private EDPMsMenuEntity edpMsMenuEntity;

    /** The from actor name. */
    @Column(name = GstDBConstants.FROM_ACTORNAME)
    private String fromActorName;

    /** The from wf role id. */
    @Column(name = GstDBConstants.FROM_WF_ROLE_ID)
    private Long fromWfRoleId;

    /** The from branch type id. */
    @Column(name = GstDBConstants.FROM_BRANCH_TYPE_ID)
    private Long fromBranchTypeId;

    /** The from office type id. */
    @Column(name = GstDBConstants.FROM_OFFICE_TYPE_ID)
    private Long fromOfficeTypeId;

    /** The from status. */
    @Column(name = GstDBConstants.FROM_STATUS)
    private String fromStatus;

    /** The from wf status. */
    @Column(name = GstDBConstants.FROM_WF_STATUS)
    private String fromWfStatus;

    /** The from level. */
    @Column(name = GstDBConstants.FROM_LEVEL)
    private int fromLevel;

    /** The condition. */
    @Column(name = GstDBConstants.CONDITION)
    private String condition;

    /** The to level. */
    @Column(name = GstDBConstants.TO_LEVEL)
    private int toLevel;

    /** The to wf status. */
    @Column(name = GstDBConstants.TO_WF_STATUS)
    private String toWfStatus;

    /** The to status. */
    @Column(name = GstDBConstants.TO_STATUS)
    private String toStatus;

    /** The to actor name. */
    @Column(name = GstDBConstants.TO_ACTORNAME)
    private String toActorName;

    /** The to work flow role id. */
    @Column(name = GstDBConstants.TO_WF_ROLE_ID)
    private Long toWorkFlowRoleId;

    /** The to branch type id. */
    @Column(name = GstDBConstants.TO_BRANCH_TYPE_ID)
    private Long toBranchTypeId;

    /** The to office type id. */
    @Column(name = GstDBConstants.TO_OFFICE_TYPE_ID)
    private Long toOfficeTypeId;

    /** The location type. */
    @ManyToOne(fetch = FetchType.LAZY, optional = false)
    @JoinColumn(name = GstDBConstants.LOCATION_TYPE, referencedColumnName = GstDBConstants.LOOKUP_INFO_ID)
    private EDPLuLookUpInfoEntity locationType;

    /** The wf action id. */
    @Column(name = GstDBConstants.WF_ACTION_ID)
    private Long wfActionId;

    /** The location value. */
    @Column(name = GstDBConstants.LOCATION_VALUE)
    private String locationValue;

    /** The from is FD. */
    @Column(name = GstDBConstants.FROM_IS_FD)
    private int fromIsFD;

    /** The is to branch sel req. */
    @Column(name = GstDBConstants.IS_TO_BRANCH_SEL_REQ)
    private int isToBranchSelReq;

    /** The is to office sel req. */
    @Column(name = GstDBConstants.IS_TO_OFFICE_SEL_REQ)
    private int isToOfficeSelReq;

    /** The is to user sel req. */
    @Column(name = GstDBConstants.IS_TO_USER_SEL_REQ)
    private int isToUserSelReq;

    /** The send back flag. */
    @Column(name = GstDBConstants.SEND_BACK_FLAG)
    private int sendBackFlag;

    /** The group version code. */
    @Column(name = GstDBConstants.GROUP_VERSION_CODE)
    private int groupVersionCode;

    /** The active status. */
    @Column(name = GstDBConstants.ACTIVE_STATUS)
    private int activeStatus;

    /** The type id. */
    @Column(name = GstDBConstants.TYPE_ID)
    private int typeId;

    /** The target menu id. */
    @Column(name = GstDBConstants.TARGET_MENU_ID)
    private Long targetMenuId;

    /** The init wf role id. */
    @Column(name = GstDBConstants.INIT_WF_ROLE_ID)
    private Long initWfRoleId;

    /** The is co. */
    @Column(name = GstDBConstants.IS_CO)
    private int isCo;

    /** The to is fd. */
    @Column(name = GstDBConstants.TO_IS_FD)
    private Integer toIsFd;

    /** The is display in popup. */
    @Column(name = GstDBConstants.IS_DISPLAY_IN_POPUP)
    private Integer isDisplayInPopup;

    /** The init wf rl pr. */
    @Column(name = GstDBConstants.INIT_WF_RL_PR)
    private int initWfRlPr;

    /** The from office sub type id. */
    @Column(name = GstDBConstants.FROM_OFFICE_SUB_TYPE_ID)
    private Long fromOfficeSubTypeId;

    /** The to office sub type id. */
    @Column(name = GstDBConstants.TO_OFFICE_SUB_TYPE_ID)
    ...
    public boolean equals(Object o) {
        if (this == o)
            return true;
        if (!(o instanceof GstWfActionConfigEntity))
            return false;
        GstWfActionConfigEntity that = (GstWfActionConfigEntity) o;
