...
/**
 * The Class GstWfActionConfigAsyncSubmitTrnResDto.
 */
@JsonInclude(JsonInclude.Include.NON_NULL)
@NativeQueryResultEntity
public class GstWfActionConfigAsyncSubmitTrnResDto implements Serializable {
	...
	public boolean equals(Object o) {
		...
		GstWfActionConfigAsyncSubmitTrnResDto that = (GstWfActionConfigAsyncSubmitTrnResDto) o;
	...
	public String toString() {
		final StringBuilder sb = new StringBuilder("GstWfActionConfigAsyncSubmitTrnResDto{");
