...
public class GstReportDtlsGstnDaywiseChallanCountDto {
	 ...
	 * 
	 */
	public GstReportDtlsGstnDaywiseChallanCountDto() {
		super();
	 ...
	 * @param amount
	 */
	public GstReportDtlsGstnDaywiseChallanCountDto(Date paymentDate, Integer noOfTotalTrns, Double amount) {
		super();
