...
public class GSTConstant {
	...
	public static String TRANSACTION_NO_GENERATION = "TRANSACTION_NO_GENERATION";
	 ...
	 */
	public static final String TRN_SCREEN_BMS = "BRM";

	/** The Constant IN_SA_DA_ID. */
	public static final String IN_SA_DA_ID = "IN_SA_DA_ID";	
	
	/** The Constant AS_ON_DATE. */
	...
	public static final String GST_SCHEMA = "EPAO";

	public static final String P_GST_TRN_NO_GEN = "TRANSACTION_NO_GENERATION";
	
	public static final String ME_CREATED_STATUS = "Created";

	public static final Long ME_CREATED_STATUS_ID = 1L;

	public static final String PI_CREATED_STATUS = "Created";

	public static final Long PI_CREATED_STATUS_ID = 1L;
	
	public static final String P_GST_TRN_NO_DIS = "TRANSACTION_NO_CURRENTVAL";

	public static final String MASTER_SCHEMA = "MASTER_V1";
	
	public static final String P_EOD_CIN_DETAILS_REPORT = "SP_EOD_CIN_DETAILS_REPORT1";
	
	public static final String P_EOD_CPIN_DETAILS_REPORT = "SP_EOD_CPIN_DETAILS_REPORT1";
	
	public static final String P_CIN_DETAILS_REPORT = "SP_CIN_DETAILS_REPORT1";
	
	public static final String P_CPIN_DETAILS_REPORT = "SP_CPIN_DETAILS_REPORT1";
	
	public static final String P_CHALLAN_STATUS_REPORT = "SP_CHALLAN_STATUS_REPORT";
	
	public static final String P_CHALLAN_STATUS_CONSOLIDATED_REPORT = "SP_CHALLAN_STATUS_CONSOLIDATED_REPORT";

	public static final String P_FILE_SUMMARY_REPORT = "SP_FILE_SUMMARY_REPORT";

	public static final String P_VOUCHER_DETAILS_REPORT = "SP_VOUCHER_DETAILS_REPORT";
	
	public static final String P_BLOCK_CPIN_REPORT = "SP_BLOCK_CPIN_REPORT";
	
	public static final String P_GSTN_VS_RBI_CHALLAN_COUNT = "SP_GSTN_VS_RBI_CHALLANCOUNT_AMOUNT_REPORT_2";

	public static final String P_GSTN_DAYWISE_CHALLAN_COUNT_AMOUNT = "SP_GSTN_DAYWISE_CHALLANCOUNT_AMOUNT_REPORT_2";
	
	public static final String P_MANUAL_ACCOUNTING_REPORT = "SP_MANUAL_ACC_REPORT1";
	
	public static final String P_RBI_DAYWISE_CHALLAN_COUNT_AMOUNT = "SP_RBI_DAYWISE_CHALLANCOUNT_AMOUNT_REPORT";

	public static final String P_CIN_MODEWISE_TAXPAYER_REPORT = "SP_CIN_MODEWISE_TAXPAYER_REPORT";
	
	public static final String P_CIN_FILE_RECEIVED_REPORT = "SP_FILE_RECEIVED_REPORT";
	
	public static final String P_EOD_CIN_VS_CIN_REPORT = "SP_EOD_CIN_VS_CIN_REPORT";
	
	public static final String P_EOD_CPIN_VS_CPIN_REPORT = "SP_EOD_CPIN_VS_CPIN_REPORT";
	
	public static final String P_SUMMARY_PENAL_INTEREST_REPORT = "SP_SUMMARY_PENAL_INTEREST_REPORT";
	
	public static final String P_RBI_SCROLL_FILE_REPORT = "SP_RBI_SCROLL_FILE_REPORT";
	
    public static final String P_RBI_SCROLL_STMNT_DATEWISE_REPORT = "SP_RBI_SCROLL_STMNT_DATEWISE_REPORT";
	
	public static final String P_RBI_SCROLL_STMNT_MONTHWISE_REPORT = "SP_RBI_SCROLL_STMNT_MONTHWISE_REPORT_1";	

	public static final String P_RBI_SCROLL_STMNT_TXN_REPORT = "SP_RBI_SCROLL_STMNT_TXN_REPORT";

	public static final String P_RBI_SCROLL_STMNT_DAYWISE_REPORT = "SP_RBI_SCROLL_STMNT_DAYWISE_REPORT";
	
	public static final String P_GSTN_FILE_RECEIVED_REPORT = "SP_GSTN_FILE_SUMMARY_REPORT";	
	
	public static final String P_MOE_TRACKING_GENERATE_REPORT = "SP_MOE_TRACKING_GENERATE_REPORT";	

	public static final String P_MOE_TRACKING_GENERATE_SUB_REPORT = "SP_MOE_TRACKING_GENERATE_SUB_REPORT";	

	public static final String P_JOTTING_VS_POSTING_REPORT = "SP_JOTTING_VS_POSTING_REPORT";	

	public static final String P_RBI_DAYWISE_SCROLL_MONITORING_PART1_REPORT = "SP_RBI_DAYWISE_SCROLL_MONITORING_PART1_REPORT";	
	public static final String P_RBI_DAYWISE_SCROLL_MONITORING_PART2_REPORT = "SP_RBI_DAYWISE_SCROLL_MONITORING_PART2_REPORT";
	
	public static final String P_RBI_PENDING_SCROLLSWISE_STATUS_REPORT = "SP_RBI_PENDING_SCROLLSWISE_STATUS_REPORT ";
	
	public static final String P_RBI_INPROCESS_SCROLLSWISE_STATUS_REPORT = "SP_RBI_INPROCESS_SCROLLSWISE_STATUS_REPORT";
	
	public static final String P_RBI_PENDING_SCROLLSWISE_TRANS_DETAILS_STATUS_REPORT = "SP_RBI_PENDING_SCROLLSWISE_TRANS_DETAILS_STATUS_REPORT ";
	
	public static final String P_PERFORMANCE_MONITORING_REPORT = "SP_PERFORMANCE_MONITORING_REPORT ";

	public static final String P_BAL_MONTRNG_BANKWISE_PENDING_TRANSACTION_COUNT_8658 = "SP_BAL_MONTRNG_BANKWISE_PENDING_TRANSACTION_COUNT_8658 ";

	public static final String P_BAL_MONTRNG_MONTHWISE_PENDING_TRANSACTION_COUNT_8658 = "SP_BAL_MONTRNG_MONTHWISE_PENDING_TRANSACTION_COUNT_8658 ";

	public static final String P_BAL_MONTRNG_TRNSWISE_PENDING_TRANSACTION_COUNT_8658 = "SP_BAL_MONTRNG_TRNSWISE_PENDING_TRANSACTION_COUNT_8658 ";
}
