...
public class MsMajorHeadEntity extends BaseEntity implements Serializable {
    ...
    private MsDemandEntity budgetMsDemandEntities;

    /**
     * Instantiates a new  ms major head entity.
     */
    public MsMajorHeadEntity() {
        super();
    }
     ...
     */
    public MsMajorHeadEntity(Long majorHeadId) {
        super();
     ...
     */
    public MsMajorHeadEntity(Long majorHeadId, String majorHeadCode) {
        super();
        this.majorHeadId = majorHeadId;
    ...
    public MsDemandEntity getBudgetMsDemandEntities(){
        return budgetMsDemandEntities;
    }

    public void setBudgetMsDemandEntities(MsDemandEntity budgetMsDemandEntities){
     ...
     */
    public MsMajorHeadEntity(String tempMajorHeadCode) {
    ...
    public boolean equals(Object o){
        ...
        if(!(o instanceof MsMajorHeadEntity)) return false;
        MsMajorHeadEntity that = (MsMajorHeadEntity) o;
