...
@Table(name = "MS_DETAILHEAD", schema = Constant.BUDGET_MASTER_SCHEMA, uniqueConstraints = @UniqueConstraint(columnNames = {
		"DETAILHEAD_ID" }))
public class MsDetailHeadEntity extends BaseEntity implements Serializable {
	...
	private MsMinorHeadEntity minorHeadEntity;
	...
	private MsSubHeadEntity subHeadEntity;

	/**
	 * Instantiates a new  ms detail head entity.
	 */
	public MsDetailHeadEntity() {
	}
	 ...
	 */
	public MsDetailHeadEntity(Long detailHeadId) {
		super();
	 ...
	 */
	public MsMinorHeadEntity getMinorHeadEntity() {
	 ...
	 */
	public void setMinorHeadEntity(MsMinorHeadEntity minorHeadEntity) {
	 ...
	 */
	public MsSubHeadEntity getSubHeadEntity() {
	 ...
	 */
	public void setSubHeadEntity(MsSubHeadEntity subHeadEntity) {
