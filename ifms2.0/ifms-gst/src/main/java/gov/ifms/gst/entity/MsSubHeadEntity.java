...
public class MsSubHeadEntity extends BaseEntity implements Serializable {
	...
	/**
	 * Instantiates a new  ms sub head entity.
	 */
	public MsSubHeadEntity() {
		super();
	}
	 ...
	 */
	public MsSubHeadEntity(Long subHeadId) {
		super();
