...
/**
 * The Class MsSubMajorHeadEntity.
 */
@Entity
@Table(name = "MS_SUBMAJORHEAD", schema = Constant.BUDGET_MASTER_SCHEMA)
public class MsSubMajorHeadEntity extends BaseEntity implements Serializable {
	...
	/**
	 * Instantiates a new  ms sub major head entity.
	 */
	public MsSubMajorHeadEntity() {
		super();
	}
	 ...
	 */
	public MsSubMajorHeadEntity(Long submajorHeadId) {
		super();
