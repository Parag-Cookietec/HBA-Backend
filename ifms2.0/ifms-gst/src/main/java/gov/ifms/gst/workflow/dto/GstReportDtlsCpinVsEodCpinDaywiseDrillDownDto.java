...
/**
 * The Class GstReportDtlsCpinVsEodCpinDaywiseDrillDownDto.
 *
 * @version 1.0
 * @created 2022/01/09 17:21:07
 *
 */
public class GstReportDtlsCpinVsEodCpinDaywiseDrillDownDto {

	/** The serialVersionUID. */
	private static final long serialVersionUID = 1L;

	public GstReportDtlsCpinVsEodCpinDaywiseDrillDownDto() {
		super();
	}
	...
	public GstReportDtlsCpinVsEodCpinDaywiseDrillDownDto(Date date, Integer cinNoOfTransaction, Double cinAmount,
