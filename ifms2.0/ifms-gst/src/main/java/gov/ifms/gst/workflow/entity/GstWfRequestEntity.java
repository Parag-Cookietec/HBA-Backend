...
/**
 * The Class GstWfRequestEntity.
 */
@Entity
@Table(name = "TPAO_WF_REQUEST", schema = GstDBConstants.GST_SCHEMA)
public class GstWfRequestEntity extends BaseEntity implements Serializable {
	...
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE,generator = "gstWfRequestSeq")
	@GenericGenerator(name = "gstWfRequestSeq",strategy = "sequence",parameters = {
			@org.hibernate.annotations.Parameter(name="sequence_name",value = "EPAO.TPAO_WF_REQUEST_ID_SEQ")
	})
	...
	public boolean equals(Object o) {
		...
		GstWfRequestEntity that = (GstWfRequestEntity) o;
	...
	public String toString() {
		final StringBuilder sb = new StringBuilder("GstWfRequestEntity{");
