...
public class DMOGOILoanDto implements Serializable{
	...
	private List<DMOGOILoanRePaymentDto> dtos;
	 ...
	 * @return the dtos
	 */
	public List<DMOGOILoanRePaymentDto> getDtos() {
		return dtos;
	}
	 ...
	 */
	public void setDtos(List<DMOGOILoanRePaymentDto> dtos) {
		this.dtos = dtos;
	}
