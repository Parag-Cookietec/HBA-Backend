...
/**
 * The Class DMOLuLookUpEntity.
 */
@Entity
@Table(name = "LU_LOOKUP", schema = DMOConstant.MASTER_V1_SCHEMA)
public class DMOLuLookUpEntity extends BaseEntity implements Serializable {
	...
	/**
	 * Instantiates a new DMO lu look up entity.
	 */
	public DMOLuLookUpEntity() {
		super();
	}
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof DMOLuLookUpEntity)) {
			return false;
		}
		DMOLuLookUpEntity other = (DMOLuLookUpEntity) obj;
