...
@RestController
@RequestMapping(DMOURLConstant.MARKET_LOAN_REPAYMENT_BASE_URL)
@CrossOrigin(origins = "*", allowedHeaders = "*")
public class DMOMarketLoanRepaymentScheduleController {

	
	@Autowired
	DMOMarketLoanRePaymentService service;
	...
	public ResponseEntity<ApiResponse> saveOrUpdateRepayment(@RequestBody DMOMarketLoanDto dto) throws CustomException {
	...
	public ResponseEntity<ApiResponse> updateRepayment(@RequestBody DMOMarketLoanRePaymentDto dto) {
